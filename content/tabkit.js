...
<settings.dtd>
    ...
    */
    ...
    this.moveTabbar = function moveTabbar(pos) {
        ...
        var fromHorizontal = flipOrient ? "vertical" : "horizontal";
        var fromVertical = flipOrient ? "horizontal" : "vertical";
		tk.log("flipOrient "+flipOrient);

        // Calculate new direction attribute
        var flipDirection = (pos == tk.Positions.RIGHT || pos == tk.Positions.BOTTOM);
		tk.log("flipDirection "+flipDirection);
        ...
        if (flipOrient) {
            if (!splitter) {
                ...
                */
				...
				tk.log("After create splitter: "+splitter);
				tk.log(grippy.id);
				...
				tk.log("gBrowser.mTabBox: "+gBrowser.mTabBox);
				tk.log("gBrowser.mPanelContainer: "+gBrowser.mPanelContainer);
